...
project = 'AgileX Scout 2.0 Documentation'
...
html_logo = "_images/logo_scout_20.png"
...
html_context = {
    ...
    'github_repo': 'agilex_scout_20_docs', # Repo name
...
htmlhelp_basename = 'AgileXScout2Documentation'
